              ...
              <table className="w-full text-left" style={{ tableLayout: 'fixed', borderCollapse: 'collapse' }}>
                ...
                <thead>
                  <tr style={{ borderBottom: `1px solid ${cardBorder}` }}>
                    ...
                    <th className="py-4 px-4 text-[10px] font-black uppercase tracking-widest" style={{ color: SILVER, minWidth: '163px' }}>Pagamento</th>
                    <th className="py-4 px-4 text-[10px] font-black uppercase tracking-widest" style={{ color: SILVER, minWidth: '460px' }}>Cliente</th>
